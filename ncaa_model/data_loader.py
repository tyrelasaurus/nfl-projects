...
def load_schedule(csv_path: str, week: int) -> List[Tuple[str, str, str]]:
    """
    Load NCAA schedule from CSV file for a specific week.
...
class DataLoader:
    """Loads power rankings and NCAA schedule data from CSV files."""
    ...
    def __init__(self, power_rankings_path: str, schedule_path: str):
        ...
        Args:
            ...
            schedule_path: Path to NCAA schedule CSV file
        """
    ...
    def load_schedule(self, week: Optional[int] = None) -> pd.DataFrame:
        """
        Load NCAA schedule from CSV, optionally filtered by week.
