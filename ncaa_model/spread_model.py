...
from .config_manager import get_ncaa_config
...
class SpreadCalculator:
    """
    NCAA point spread prediction engine implementing Billy Walters-inspired methodology.
    ...
    def __init__(self, home_field_advantage: Optional[float] = None, config=None):
        ...
        Args:
            home_field_advantage: Points to add for home team. If None, uses
                                config value or FBS average of ~3.0 points.
        ...
        Typical FBS home field advantages by venue type:
        - Power programs with large stadiums: 3.0-4.0 points
        - Group of Five / smaller venues: 2.0-3.0 points
        - Extreme travel/altitude spots: 4.0+ points
        """
        self.config = config or get_ncaa_config()
